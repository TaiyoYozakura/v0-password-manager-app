    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-6 md:px-8 md:py-10">
      ...
      <Card className="mt-4">
        <CardHeader>
          ...
          <CardDescription>
            Download an encrypted JSON file of all entries, protected by a passphrase you choose.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={exportOpen} onOpenChange={setExportOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose a passphrase. The file will be AES-256 encrypted with it.
              You&apos;ll need this exact passphrase to decrypt the file later.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-2">
